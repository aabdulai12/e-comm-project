class HomeController < ApplicationController
  ...
  before_action :set_cart, only: %i[checkout place_order]
  ...
  # Find the last 5 products added
  def new
  ...
  def create
    ...
    if new_customer.save
      ...
      flash[:error] =
        "There was an issue creating your customer profile: #{new_customer.errors.full_messages.join(', ')}"
      redirect_to cart_path
    end
